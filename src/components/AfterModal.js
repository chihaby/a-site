...
const ModalExampleScrollingContentForAfter = () => (
  <Modal trigger={<Button style={{backgroundColor: 'rgb(49,61,85)', color: 'white', margin: '2em 1em'}}>After Her</Button>}>
    <Modal.Header>After Her</Modal.Header>
...
export default ModalExampleScrollingContentForAfter;
